...
function [matches] = stringmatch()
tic;

string2search = 'and this string is added to help in better analysis';  % you can use 'the king' or 'wonderland' also
num_tasks = 8;
